...
public class TranslateActivity extends BaseCompatActivity implements TranslatePresenter.TranslateCallback2V<TransInfoD> {
    ...
    private void startListen(){
        Bundle bundle = new Bundle();
        bundle.putString(getString(R.string.recycle_from_key), SCENE_TRANS);
        bundle.putBoolean(getString(R.string.recycle_expression_key), false);
        MyAppUtils.sendBroadcast(getApplicationContext(), ACT_RECYCLE_LISTEN, bundle);
    }
    ...
    private void stopListen(){
        Bundle bundle = new Bundle();
        bundle.putString(getString(R.string.recycle_from_key), SCENE_TRANS);
        MyAppUtils.sendBroadcast(getApplicationContext(), ACT_STOP_LISTEN, bundle);
    }
