...
public abstract class BaseHandler {
    ...
    // 类型为播放音乐
    public static final String PLAYER_CATEGORY_MUSIC = "music";
    // 类型为搜索音乐
    public static final String PLAYER_CATEGORY_MUSIC_SEARCH = "music_search";
    // 类型为控制音乐
    public static final String PLAYER_CATEGORY_MUSIC_CTRL = "music_ctrl";
    // 类型为播放视频
    public static final String PLAYER_CATEGORY_VIDEO = "video";
    // 播放数据的KEY
