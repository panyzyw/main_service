package com.zccl.ruiqianqi.mind.voice.iflytek.function;
/**
 * 科大讯飞后台功能类型
 */
public class FuncType {
	...
	public static final String FUNC_TRANSLATE = "translation";
	...
	/****************************【私有语义场景，和通用语义场景有重复】****************************/
	// 翻译
	public static final String FUNC_TRANSLATE_ = "tran";
	// 查询提醒、删除提醒
