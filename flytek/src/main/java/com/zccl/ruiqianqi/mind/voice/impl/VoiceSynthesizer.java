...
import com.zccl.ruiqianqi.mind.voice.impl.beans.asr.PlusResult;
...
public final class VoiceSynthesizer extends BaseVoice implements SynthesizerListener {
    ...
    private void initParam() {
        ...
        if (Configuration.E_SPEAKER_TYPE.TYPE_SPEAKER_ONLINE == Configuration.SPEAKER_TYPE) {
            ...
            // 设置发音人
            speechSynthesizer.setParameter(SpeechConstant.VOICE_NAME, SPEAKER_NAME);
    ...
    private String getResourcePath() {
        ...
        tempBuffer.append(";");
        //发音人资源
        tempBuffer.append(ResourceUtil.generateResourcePath(mContext, ResourceUtil.RESOURCE_TYPE.assets, "tts/" + SPEAKER_NAME + ".jet"));
