        ...
        try {
            ...
            // 传感器状态改变了
                ...
                if(text.equals(mContext.getString(R.string.sensor_touch)) ||
                    ...
                    mRobotVoice.setExpressionState(true, true);

                    mRobotVoice.handlerVoiceEntry(mContext.getString(R.string.sensor_touch));
            ...
            // 任务完成后的循环监听来了
                ...
                if(StringUtils.isEmpty(listenEvent.getFrom())){
                    ...
                    mRobotVoice.setExpressionState(listenEvent.isUseVoiceFloat(), listenEvent.isUseExpression());
                    mRobotVoice.handlerVoiceEntry(listenEvent.getFrom());
                }
            }
