...
public class RobotVoice extends VoiceManager {
    ...
    private void init(){
        ...
        noNets = mContext.getResources().getStringArray(R.array.no_net_use);
    ...
    private void onError_(Throwable error){
        ...
        // 【正常结束，则做理解次数记录】
            ...
            try {
                ...
                else if (NO_NET_10114 == speechError.getErrorCode() ||
                        NO_NET_10212 == speechError.getErrorCode() ||
                        NO_NET_20002 == speechError.getErrorCode()) {
                    errMsg = noNets[CheckUtils.getRandom(noNets.length)];
                }
                else {
                    errMsg = speechError.getErrorDescription();
                }
