...
import com.zccl.ruiqianqi.mind.voice.iflytek.beans.MusicBean;
...
public class MusicPresenter extends BasePresenter {
     ...
     * @param json
     */
    public void flyTekYuDian(String json){
        LogUtils.e(TAG, "flyTekYuDian");
        ...
        // 解析音乐播放
        else if(FUNC_MUSIC.equals(service) || FUNC_VIDEO.equals(service)){
