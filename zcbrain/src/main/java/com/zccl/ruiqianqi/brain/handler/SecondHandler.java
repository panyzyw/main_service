...
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_ARITHMETIC;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_BATTERY;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_CALL;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_CAMERA;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_CHAT;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_COOKBOOK;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_DANCE;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_EMOTION_CHAT;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_ENCYCLOPEDIAS;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_FACE;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_HABIT;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_HEALTH;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_JOKE;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_MAP;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_MOVIE_INFO;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_NEWS;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_OPERA;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_PHOTO;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_QUESTION;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SCHEDULE;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SHUTDOWN;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SINOLOGY;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SMART_HOME;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SOUND;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_SQUARE_DANCE;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_STOCK;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_STORY;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_STUDY;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_TRANSLATION;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_WEATHER;
import static com.zccl.ruiqianqi.brain.semantic.FuncIntent.INTENT_YYDCHAT;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_ARITHMETIC;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_BAI_KE;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_BATTERY;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_CALL;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_CAMERA;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_CHAT;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_COOKBOOK;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_DANCE;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_DATETIME;
...
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_JOKE;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_MAP;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_MOVIE_INFO;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_NEWS;
...
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_PHOTO;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_QUSETION;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_SCHEDULE;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_SHUTDOWN;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_SINOLOGY;
...
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_STOCK;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_STORY;
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_STUDY;
...
import static com.zccl.ruiqianqi.brain.semantic.flytek.FuncType.FUNC_WEATHER;
...
public class SecondHandler extends BaseHandler {
    ...
    // 类标志
    private static String TAG = SecondHandler.class.getSimpleName();
    // 服务对应的广播
    private Map<String, String> intentMap;
    // 离线回答
    private String[] mAnswers;

    public SecondHandler(Context context, RobotVoice robotVoice){
    ...
    public boolean handleSemantic(String json, String funcType) {
        ...
        return doRemoteFunc(json, funcType);
    }
     ...
     * @param funcType     功能类型
     */
    private boolean doRemoteFunc(String json, String funcType){
    ...
    public boolean handleAsr(String asr, int type) {
        ...
        if(OFF_LINE_MUSIC.equals(asr)){
            ...
            return doRemoteFunc(SEMANTIC_CAMERA, FUNC_CAMERA);
        }
        else if(OFF_LINE_SHUTDOWN.equals(asr)){
            return doRemoteFunc(SEMANTIC_SHUTDOWN, FUNC_SHUTDOWN);
        }
        else if(OFF_LINE_PHOTOS.equals(asr)){
            return doRemoteFunc(SEMANTIC_PHOTO, FUNC_PHOTO);
        }
            ...
            if(1 == type){
                return doRemoteFunc(SEMANTIC_DOWNLOAD_QR, FUNC_YYD_CHAT);
            }else {
                return doRemoteFunc(SEMANTIC_BIND_QR, FUNC_YYD_CHAT);
            }
        }
