...
LOCAL_SRC_FILES := $(call all-java-files-under, ext_five/java)
...
LOCAL_PREBUILT_STATIC_JAVA_LIBRARIES := \
	libservice1:ext_five/libs/alsarecorder.jar \
	libservice2:ext_five/libs/Cae.jar \
	libservice3:libs/gson-2.2.4.jar \
	libservice4:libs/MotorService.jar \
	libservice5:ext_five/libs/Msc.jar \
...
LOCAL_SRC_FILES_32 := ext_five/libs/armeabi/libalsa-jni.so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libcae
LOCAL_SRC_FILES_32 := ext_five/libs/armeabi/libcae.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
include $(BUILD_PREBUILT)
...
include $(CLEAR_VARS)
LOCAL_MODULE := libmsc
LOCAL_SRC_FILES_32 := ext_five/libs/armeabi/libmsc.so
LOCAL_MULTILIB := 32
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
include $(BUILD_PREBUILT)
