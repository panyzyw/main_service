...
//				SendBroadcastUtils.sendBroad(context, map2);
                ...
                }if (robotCmd.command.type.equals("head_up")) {
                    mMotorController.setDrvType(DRVTYPE_BY_TIME);
                    mMotorController.setSpeed(30);
                    mMotorController.headUp(1000);
                } else if (robotCmd.command.type.equals("head_down")) {
                    mMotorController.setDrvType(DRVTYPE_BY_TIME);
                    mMotorController.setSpeed(30);
                    mMotorController.headDown(1000);
                } else if (robotCmd.command.type.equals("head_left")) {
                    mMotorController.setDrvType(DRVTYPE_BY_TIME);
                    mMotorController.setSpeed(30);
                    mMotorController.headLeft(1000);
                } else if (robotCmd.command.type.equals("head_right")) {
                    mMotorController.setDrvType(DRVTYPE_BY_TIME);
                    mMotorController.setSpeed(30);
