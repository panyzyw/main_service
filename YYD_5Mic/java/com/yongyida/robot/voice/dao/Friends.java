...
public class Friends implements BaseColumns {
    ...
    public static final String SQL_CREATE_TABLE_ROBOTS = String.format(
            "CREATE TABLE %s(_id integer primary key autoincrement, %s text, %s text, %s text, %s text, %s text, %s text, %s text, %s text, %s text)",
            ROBOTS_TABLE,
            ROBOTS_CONTROLLER,
            ROBOTS_RNAME,
            ROBOTS_SERIAL,
    ...
    public static final String SQL_CREATE_TABLE_USERS = String.format(
            "CREATE TABLE %s(_id integer primary key autoincrement, %s text, %s text, %s text, %s text, %s text, %s text)",
            USERS_TABLE,
            USERS_CONTROLLER,
            USERS_PHONE,
            USERS_HEADSHOT,
