package com.yongyida.robot.voice.mic;
...
public class MicTestActivity extends Activity {
    ...
    private static final int MIC0=1,MIC1=7,MIC2=2,MIC3=8,MIC4=3,MIC5=9,MIC6=4,MIC7=10;
    private ImageView forwardMic,midMic,leftMic,rightMic,backMic,noiseMic,speak1Mic,speak2Mic;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case MIC4:
                    ...
                    break;
                case MIC5:
                    //noiseMic.setBackground(getResources().getDrawable(R.drawable.light_green));
                    break;
                case MIC6:
    ...
    private Handler mHandlerTest=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            testState.setTextColor(Color.parseColor("#FF0DF50D"));
        }
    };
    ...
    private void init_view(){
        ...
        //noiseMic=(ImageView)findViewById(R.id.noise_mic);
    ...
    private void resetAll(){
        ...
        //noiseMic.setBackground(getResources().getDrawable(R.drawable.light_white));
